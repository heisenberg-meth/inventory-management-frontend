...
const recentOrders = [
  { id: 'ORD-1284', type: 'Sales', amount: '₹4,290', status: 'Completed', statusColor: 'var(--color-mint)' },
  { id: 'ORD-1283', type: 'Purchase', amount: '₹12,450', status: 'Pending', statusColor: 'var(--color-warning)' },
  { id: 'ORD-1282', type: 'Sales', amount: '₹2,180', status: 'Completed', statusColor: 'var(--color-mint)' },
  { id: 'ORD-1281', type: 'Sales', amount: '₹6,720', status: 'Shipped', statusColor: 'var(--color-info)' },
  { id: 'ORD-1280', type: 'Purchase', amount: '₹8,910', status: 'Cancelled', statusColor: 'var(--color-danger)' },
];
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span 
                    ...
                    style={{ 
                      backgroundColor: `${order.type === 'Sales' ? 'var(--color-mint)' : 'var(--color-info)'}20`,
                ...
                <div className="flex items-center gap-4">
                  <div className="text-sm font-semibold text-[var(--color-text-primary)]">{order.amount}</div>
                  <span 
                    className="px-2 py-1 rounded-full text-xs font-medium"
