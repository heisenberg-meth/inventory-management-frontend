...
export const Customers: React.FC = () => {
  ...
  const openEdit = (c: Customer) => { setEditing(c); setForm({ name: c.name, contact: c.contact, email: c.email, phone: c.phone, type: c.type, status: c.status }); setShowModal(true); };
