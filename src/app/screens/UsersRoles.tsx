...
const roleColor = (role: string) => {
  switch (role) {
    case 'Admin': return 'bg-[var(--color-danger)]/20 text-[var(--color-danger)]';
    case 'Manager': return 'bg-[var(--color-warning)]/20 text-[var(--color-warning)]';
    case 'Staff': return 'bg-[var(--color-info)]/20 text-[var(--color-info)]';
