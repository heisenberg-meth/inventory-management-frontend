...
const TRANSFERS: Transfer[] = [
  {
    id: 'trf-1', ref: 'TRF-001',
    from: 'Main Warehouse',   fromIcon: '🏭',
    to: 'ABC Pharmacy Branch', toIcon: '🏥',
    date: 'Mar 23, 2026', items: 5,  status: 'completed',
  },
  {
    id: 'trf-2', ref: 'TRF-002',
    from: 'Central Store',    fromIcon: '🏭',
    to: 'Retail Outlet #2',   toIcon: '🏪',
    date: 'Mar 22, 2026', items: 3,  status: 'in-transit',
  },
  {
    id: 'trf-3', ref: 'TRF-003',
    from: 'Main Warehouse',   fromIcon: '🏭',
    to: 'City Hospital',      toIcon: '🏥',
    date: 'Mar 21, 2026', items: 12, status: 'pending',
  },
  {
    id: 'trf-4', ref: 'TRF-004',
    from: 'Retail Outlet #1', fromIcon: '🏪',
    to: 'Main Warehouse',     toIcon: '🏭',
    date: 'Mar 20, 2026', items: 2,  status: 'completed',
  },
  {
    id: 'trf-5', ref: 'TRF-005',
    from: 'Central Store',    fromIcon: '🏭',
    to: 'Clinic Branch',      toIcon: '🏥',
    date: 'Mar 18, 2026', items: 8,  status: 'pending',
  },
  {
    id: 'trf-6', ref: 'TRF-006',
    from: 'ABC Pharmacy',     fromIcon: '🏥',
    to: 'Main Warehouse',     toIcon: '🏭',
    date: 'Mar 15, 2026', items: 1,  status: 'cancelled',
  },
];
...
export const StockTransfers: React.FC = () => {
  ...
  const filtered = TRANSFERS.filter((t) => {
    ...
    const tabMap: Record<string, TransferStatus> = {
      Pending: 'pending',
      'In Transit': 'in-transit',
      Completed: 'completed',
      Cancelled: 'cancelled',
    };
    return t.status === tabMap[activeTab];
  });
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-2">
                          <span className="text-base">{t.fromIcon}</span>
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-2">
                          <span className="text-base">{t.toIcon}</span>
                          <span className="text-sm text-[var(--color-text-primary)] whitespace-nowrap">
                            {t.to}
                          </span>
                        </div>
