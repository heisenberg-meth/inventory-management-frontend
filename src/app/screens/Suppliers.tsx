...
export const Suppliers: React.FC = () => {
  ...
  const openEdit = (s: Supplier) => { setEditing(s); setForm({ name: s.name, contact: s.contact, email: s.email, phone: s.phone, address: s.address, category: s.category, status: s.status }); setShowModal(true); };
