    ...
    <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="flex gap-2">
          <div className="flex items-center gap-2 bg-[var(--color-card-bg)] border border-[var(--color-border)] rounded-lg px-3 py-2">
            ...
            <select
              ...
              className="bg-transparent text-sm text-[var(--color-text-primary)] focus:outline-none"
            >
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <div
                  className={`flex items-center gap-1 text-xs font-semibold ${m.up ? "text-[var(--color-mint)]" : "text-[var(--color-danger)]"}`}
                >
                  {m.up ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-[var(--color-card-bg)] border border-[var(--color-border)] rounded-xl p-5">
          <h3 className="font-semibold text-[var(--color-text-primary)] mb-5">
            Sales by Category
          </h3>
      ...
      <div className="bg-[var(--color-card-bg)] border border-[var(--color-border)] rounded-xl p-5">
        <div className="flex items-center justify-between mb-5">
          ...
          <button className="text-sm text-[var(--color-mint)] hover:underline">
            View All
          </button>
        </div>
            ...
            return (
              <div key={i}>
                <div className="flex justify-between text-sm mb-1.5">
                  <div className="flex items-center gap-2">
                    <span className="w-5 h-5 rounded-full bg-[var(--color-surface-secondary)] flex items-center justify-center text-xs font-bold text-[var(--color-text-secondary)]">
                      {i + 1}
                    </span>
                  ...
                  <div className="text-right">
                    ...
                    <span className="ml-3 font-semibold text-[var(--color-mint)]">
