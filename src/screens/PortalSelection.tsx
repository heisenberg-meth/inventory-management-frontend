      ...
      <nav className="h-20 px-6 sm:px-12 flex items-center justify-between z-10">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col leading-none">
            <span
              className="font-black text-[22px] tracking-wide text-[var(--color-text-primary)]"
              style={{
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 py-12 z-10">
        ...
        <div className="text-center max-w-4xl mb-16">
          <h1 className="text-4xl sm:text-6xl font-extrabold text-[var(--color-text-primary)] mb-6 leading-tight">
            Welcome to{" "}
            <span className="bg-gradient-to-r from-[var(--color-mint)] to-[#34D399] bg-clip-text text-transparent">
              StockFlow
            </span>
          </h1>
          <p className="text-lg sm:text-xl text-[var(--color-text-secondary)] max-w-2xl mx-auto leading-relaxed opacity-80">
            Choose your login portal to manage your inventory ecosystem with
            precision and peak efficiency.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 w-full max-w-5xl">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-[var(--color-text-secondary)] leading-relaxed opacity-70">
                Access the master control panel to manage multiple tenants,
                configure global subscription plans, and monitor system-wide
          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-[var(--color-text-secondary)] leading-relaxed opacity-70">
                The core business interface. Manage your catalog of products,
                real-time stock levels, supplier relationships, warehouse
                logistics, and comprehensive sales reporting.
              </p>
            </div>
