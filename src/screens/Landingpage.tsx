        ...
        <div className="flex gap-1">
          {[0, 1, 2].map((i) => (
            <div
              ...
              style={{ background: [t.border, t.accent, t.primary][i] }}
            />
          ))}
        </div>
      </div>
      <div className="p-3">
              ...
              <div className="flex items-end h-full gap-1 p-2">
                {[40, 70, 55, 85, 65, 90].map((h, i) => (
                  <div
                    ...
                    style={{
                      height: `${h}%`,
                      background: i % 2 === 0 ? "#34D399" : "#0F766E",
                    }}
                  />
                ))}
              </div>
        ...
        {variant === 1 && (
          <div className="space-y-1.5">
            <div
              className="flex gap-2 pb-1 border-b"
            ...
            {["Laptop Pro", "Wireless Mouse", "USB Hub"].map((item, i) => (
              <div key={i} className="flex gap-2 items-center">
                ...
                <div className="flex-1 text-xs" style={{ color: t.textMuted }}>
                  SKU-{100 + i}
                </div>
                <div className="flex-1 text-xs" style={{ color: t.textMuted }}>
                  Electronics
        ...
        {variant === 2 && (
          <div className="space-y-2">
            <div className="grid grid-cols-2 gap-2">
              {[
                { l: "Total Items", v: "2,847", c: "#34D399" },
                { l: "Warehouses", v: "5", c: "#60a5fa" },
              ].map((s, i) => (
                <div
                  key={i}
                  className="rounded-lg p-2"
            ...
            <div className="flex items-end gap-1 h-14">
              {[55, 70, 45, 80, 60, 90, 75].map((h, i) => (
                <div
                  ...
                  style={{
                    height: `${h}%`,
                    background: `rgba(52,211,153,${0.3 + i * 0.1})`,
                  }}
                />
              ))}
            </div>
              ...
              {[
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      color: [s.v.includes("+") ? "#34D399" : t.textPrimary][0],
                    }}
                  >
                    {s.v}
                  </div>
